...
class Tb_agendaController extends SecureController
{
	...
	function index($fieldname = null, $fieldvalue = null)
	{
		...
		if (!empty($request->search)) {
			...
			$search_condition = "(
				...
				tb_agenda.Penyelenggara LIKE ? OR 
				tb_agenda.Jam LIKE ? OR 
				tb_agenda.Tanggal LIKE ? OR 
				tb_agenda.Tempat LIKE ? OR 
		...
		$this->view->report_hidden_fields = array('id', 'Tanggal');
	...
	function add($formdata = null)
	{
		...
		$page_title = $this->view->page_title = "Tambah Agenda";
